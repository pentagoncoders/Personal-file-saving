  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
        <li class="dropdown">
          <?php $query= mysqli_query($conn,"select * from register where user_ID = '$session_id'") or die("ERROR: Could not connect. " . mysqli_connect_error());
                ...
                <section class="dropdown-menu on aside-md m-l-n">
                  <section class="panel bg-white">
                    ...
                    <div class="panel-body animated fadeInRight">
                      <p><a href="#" target="_blank" class="btn btn-sm btn-facebook"></a></p>
                    </div>
                  </section>
                </section>
              </div>
                        ...
                        <section class="panel clearfix bg-info lter">
                          <div class="panel-body">
                            <a href="#" class="thumb pull-left m-r">
                              <img src="images/pro.png" class="img-circle">
                            </a>
                            <div class="clear">
                              <a href="#" class="text-info">@Mr. Efex<i class="fa fa-twitter"></i></a>
                              <small class="block text-muted">Mr. Efex Personal Note Taking Software!!!</small>
                            </div>
                          </div>
                        </section>
                      </div>
